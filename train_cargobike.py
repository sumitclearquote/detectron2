...
def setup():
	...
	cfg.MODEL.WEIGHTS = 'cargobike_training_dir/exp5/model_final.pth'
	...
	cfg.SOLVER.BASE_LR = 0.00001 #0.004 #=0.0002  #0.000275, 0.005  # considering default lr for bsize 16 is 0.02. 0.02/4 = 0.005. 0.0015/4
